...
- **聊天模板与推理控制** — 新增聊天模板文件、推理模式与推理格式参数，并在参数指南中说明用途
- **多模态参数完善** — 可控制 mmproj 自动发现与 offload；默认保持 llama.cpp 的启用语义
- **内置聊天增强** — 助手回答支持标题、列表、代码、链接等基础 Markdown 渲染
- **界面与启动优化** — 将 Jinja 聊天模板选项归入聊天模板区域，并提供可直接运行 `main.py` 的启动脚本
...
<div align="center">
  <img src="img/main.png" width="90%" alt="主界面" />
  <br/>
  <b>📋 主界面</b> — 参数配置与服务控制
  <br/><br/>
  <table>
    <tr>
      <td align="center"><img src="img/model_library.png" width="100%" alt="模型库" /></td>
      <td align="center"><img src="img/chat.png" width="100%" alt="聊天面板" /></td>
      <td align="center"><img src="img/model_download.png" width="100%" alt="下载面板" /></td>
    </tr>
    <tr>
...
| 🤔 聊天模板与思考/推理 | 自定义聊天模板文件、思考模式开关、格式、预算（用于 DeepSeek-R1 等模型） |
| 🖼️ 多模态 | mmproj 自动加载、视觉编码器 GPU 卸载、图像 token 范围 |
...
编译产物输出到 `dist/main.dist/llm-launcher.exe`，包含资源文件；首次启动会自动创建默认配置，可直接分发。
